...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/market/midnight/:id', destination: '/midnight/:id', permanent: true },
      ...
      { source: '/curator/morpho', destination: '/curator', permanent: true },
      { source: '/curator/cctp', destination: '/curator', permanent: true },
      { source: '/morpho', destination: '/curator', permanent: true },
      { source: '/morpho/bots', destination: '/curator/bots', permanent: true },
      ...
      { source: '/vault/:address/analytics', destination: '/vault/:address/risk', permanent: true },
