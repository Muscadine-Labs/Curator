          ...
          <Card>
            ...
            <CardContent className="grid gap-3 text-sm">
              <SnapshotRow
                ...
                value={formatCompactUSD(market.raw.state?.supplyAssetsUsd ?? 0)}
              />
              <SnapshotRow
                label="Total Borrow (USD)"
                value={formatCompactUSD(market.raw.state?.borrowAssetsUsd ?? 0)}
              />
              <SnapshotRow
                label="Available Liquidity"
                value={formatCompactUSD(market.raw.state?.liquidityAssetsUsd ?? 0)}
              />
              <SnapshotRow
                label="TVL"
                value={formatCompactUSD(
                  market.raw.state?.sizeUsd ??
                    market.availableLiquidity + market.potentialInsolvencyUsd
                )}
              />
              <SnapshotRow
