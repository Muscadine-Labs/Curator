...
import { fetchUserVaultPositions } from '@/lib/morpho/fetch-user-vault-positions';
import { defaultCuratorMarketChainId } from '@/lib/morpho/curator-markets';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const positions = await fetchUserVaultPositions(address, chainId);
